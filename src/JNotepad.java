 ...
 */
// Scott Griswold  4/98
// Modified to be JInternalFrame for Java Portable Desktop Manager

public class JNotepad extends JInternalFrame {
	
	public JNotepad() {
		//super("NotePad", true, true, true);
		getContentPane().setLayout(new BorderLayout());
		getContentPane().add(new Notepad(),"Center");	//add the panel
		setSize(400,400);	
		setClosable(true);
		setMaximizable(true);
	...
	public static void main(String[] args) {
      try {
      	JFrame f = new JFrame();
      	//f.setTitle(resources.getString("Title"));
			f.setBackground(Color.lightGray);
				
			JDesktopPane desktop = new JDesktopPane();
		  	desktop.setOpaque(false);	
		  	desktop.add(new JNotepad(), new Integer(10)); //specify layer number higher covers lower

			f.getContentPane().add("Center",desktop );
			//frame.pack();
			f.setSize(500, 600);
      		f.show();
      } catch (Throwable t) {
...
class Notepad extends JPanel implements UndoableEditListener {
    ...
    public Notepad() {
        ...
        try {
            ...
            try {((JNotepad)getParent()).setClosed(true);}
