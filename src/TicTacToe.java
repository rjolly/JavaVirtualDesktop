...
// Scott Griswold  4/98
// Modified to be JInternnal Frame and other changes for use with
// Java Portable Desktop Manager

public class TicTacToe extends JInternalFrame implements MouseListener {

  int white; //computers current position

  int black; // opponents  current position

  // Who goes first in the next game?
  boolean first = true;

  Image notImage; //white
	Image crossImage; //black
  ...
  */
  ...
  boolean myMove() {
	...
	public void mouseReleased(MouseEvent e) {
		...
		int x = e.getX();
		int y = e.getY()-25;// title bar height
		switch (status()) {
	  		case WIN:
	  		case LOSE:
	  		case STALEMATE:
